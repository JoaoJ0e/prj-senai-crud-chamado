...
public class ClienteDao {
    ...
    public boolean inserir(Cliente cliente) {
        ...
        cliente.setId(null);
        String sql = "INSERT INTO cliente (nome, email, senha, cpf, data_criacao) VALUES (?, ?, ?, ?, ?)";
        ...
        try (Connection conexao = FabricaDeConexao.obterConexao();
            ...
            statement.setDate(5, Date.valueOf(cliente.getDataCriacao()));
    ...
    public List<Cliente> listar() {
        ...
        try (Connection conexao = FabricaDeConexao.obterConexao();
            ...
            while (resultado.next()) {
                ...
                cliente.setDataCriacao(resultado.getDate("data_criacao") != null ? resultado.getDate("data_criacao").toLocalDate() : null);
    ...
    public boolean atualizar(Cliente cliente) {
        ...
        String sql = "UPDATE cliente SET nome = ?, email = ?, senha = ?, cpf = ? WHERE id = ?";
    ...
    public Cliente buscarPorId(Long id) {
        ...
        String sql = "SELECT id, nome, email, senha, cpf, data_criacao FROM cliente WHERE id = ?";
